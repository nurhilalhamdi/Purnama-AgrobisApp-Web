...
class CekHarian_Model extends CI_model
{
    ...
    public function getDataHarianWhereIdChickin($id_chickin)
    {
        # code...
        $query = $this->db->query("SELECT * FROM tabel_pengecekan_harian JOIN tabel_chickin ON tabel_pengecekan_harian.id_chickin = tabel_chickin.id_chickin WHERE tabel_pengecekan_harian.id_chickin = $id_chickin;");
        return $query->result();
    }



    public function getDataHarianWhereId($idkdg)
    {
        ...
        $query = $this->db->query("SELECT * FROM tabel_pengecekan_harian WHERE id_kandang = $idkdg;");
        return $query->result();
    }
    ...
    public function getCekharianById($id)
    {
        ...
        $query = $this->db->get_where('tabel_pengecekan_harian', ['id' => $id]);
        return $query->row_array();
