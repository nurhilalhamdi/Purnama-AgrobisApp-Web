        ...
        <div class="row">
            <div class="col-lg">
                <div class="p-5">
                    ...
                    <form class="user" method="post" action="<?= base_url ('login/login/registration')?>">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control form-control-user" id="nomor" name="nomor"
                                placeholder="Telepon" value="<?= set_value('nomor'); ?>">
                    ...
                    <div class="text-center">
                        <a class="small" href="<?= base_url('login/login'); ?>">Already have an account? Login!</a>
                    </div>
                </div>
            </div>
        </div>
