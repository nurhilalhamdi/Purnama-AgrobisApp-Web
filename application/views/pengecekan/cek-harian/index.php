                ...
                <div class="row mb-2">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="page-title-box">
                                    <h4 class="page-title">Data Recording Harian</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Data Recording Harian</li>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <select class=" form-control" id="pilih_periode" name="pilih_periode" required>
                        ...
                        <div class="react-bootstrap-table table-responsive col-md-12">
                            ...
                            <table id="tabel_harian" class="table table-striped" style="text-align: center;">
                                <thead>
                                    <tr>
