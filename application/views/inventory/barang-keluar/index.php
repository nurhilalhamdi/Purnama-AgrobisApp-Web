                            ...
                            <table id="barangmasuk" class="table table-striped" style="text-align: center;">
                                <thead>
                                    <tr>
                                        ...
                                        <th tabindex="0" aria-label="Nomor Produk sortable" class="sortable">Kode Keluar<span class="order"><span class="dropdown"><span class="caret"></span></span><span class="dropup"><span class="caret"></span></span></span></th>
                                        ...
                                        <th tabindex="0" aria-label="Kategori sortable" class="sortable">Tanggal Keluar<span class="order"><span class="dropdown"><span class="caret"></span></span><span class="dropup"><span class="caret"></span></span></span></th>
                                        ...
                                        <th tabindex="0" aria-label="Harga Beli sortable" class="sortable">Keterangan<span class="order"><span class="dropdown"><span class="caret"></span></span><span class="dropup"><span class="caret"></span></span></span></th>
                                    ...
                                    if (!empty($barangkeluar)) {
                                        ...
                                        foreach ($barangkeluar as $bk) : ?>
                                            <tr>
                                                ...
                                                <td><?= $bk['nomor_keluar']; ?></td>
                                                <td style="text-align: start;"><a class="text-body nama" href="/products/read/2198">
                                                        <p class="m-0 d-inline-block align-middle font-16 text-primary"><?= $bk['nama']; ?></p>
                                                    </a></td>
                                                <td><?= $bk['created_at']; ?></td>
                                                <td><?= $bk['kategori']; ?></td>
                                                <td><span class="m-0 d-inline-block align-middle font-weight-bold text-success"><?= $bk['stok_keluar']; ?></span></td>
                                                <td><?= $bk['satuan']; ?></td>
                                                <td><span>Dikirim Ke ID Kandang <span style="font-weight: bold;"><?= $bk['id_kandang']; ?> </span> Alamat <?= $bk['alamat_kandang']; ?></span> </td>
                                                <td class="table-action">
                                                    <div class="row d-flex justify-content-center">
                                                        ...
                                                        <div class="col-sm-3"><a class="hapus-masuk" data-id="" data-toggle="modal" data-target="#modal-default" href="#"><i class="fal fa-trash-alt"></i></a></div>
